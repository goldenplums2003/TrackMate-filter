...
#define maxCA_M1 6374
#define maxCA_M2 4936
#define maxCA_M3 8398
#define maxCA_M4 5346
#define maxCA_M5 15502
#define maxCA_M6 6080
...
int main(void){
	...
	EdgeTimeList[1][0] = maxCA_M1-1;
	EdgeTimeList[2][0] = maxCA_M2-1;
	EdgeTimeList[3][0] = maxCA_M3-1;
	EdgeTimeList[4][0] = maxCA_M4-1;
	EdgeTimeList[5][0] = maxCA_M5-1;
	EdgeTimeList[6][0] = maxCA_M6-1;
