...
#define maxCA_M1 10030
#define maxCA_M2 8733
#define maxCA_M3 10774
#define maxCA_M4 10754
#define maxCA_M5 36049
#define maxCA_M6 23172
...
int main(void){
	...
	TrackIDList[1][0] = maxCA_M1-4;
	TrackIDList[2][0] = maxCA_M2-4;
	TrackIDList[3][0] = maxCA_M3-4;
	TrackIDList[4][0] = maxCA_M4-4;
	TrackIDList[5][0] = maxCA_M5-4;
	TrackIDList[6][0] = maxCA_M6-4;
	...
	do{
		...
		for (int i = 1; i <= mm; i++) {
			if (TrackIDList[reg][i] == TrackIDList[reg][i+1]) {
				DXList[reg][i] = EdgeXList[reg][i+1] - EdgeXList[reg][i];
